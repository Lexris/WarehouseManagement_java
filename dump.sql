...
CREATE TABLE `orderView` (
  ...
  KEY `product` (`product`),
  CONSTRAINT `orderview_ibfk_1` FOREIGN KEY (`name`) REFERENCES `client` (`name`) ON DELETE CASCADE,
  CONSTRAINT `orderview_ibfk_2` FOREIGN KEY (`product`) REFERENCES `product` (`name`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_stock` AFTER INSERT ON `orderview` FOR EACH ROW begin
...
--
-- Dumping events for database 'order_management'
--

--
-- Dumping routines for database 'order_management'
--
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_new_order`(clientName varchar(45), productName varchar(45), quantity double)
begin
...
-- Dump completed on 2020-04-15 10:17:17
